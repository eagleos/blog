# 虾米云栈 xmyy.com 全站文章分类目录

虾米云栈 xmyy.com 致力于打造专业的IT技术门户，汇聚人工智能、网络安全、云计算、云原生、数据库、大数据、软件开发及操作系统等领域，汇聚原创技术文章、开源项目、技术教程、企业级架构实践、运维经验等，为开发者、运维工程师、架构师、安全工程师等提供一站式技术学习平台。

本文档展示了网站的所有文章按分类的树状结构。

## 📁 在线2FA

- 📄 [在线2FA](https://xmyy.com/2fa/)：2FA 在线验证码生成器

## 📁 开发工具

- 📄 [开发工具](https://xmyy.com/tools/)：为开发者打造的高效工具平台，汇集了最实用的在线工具，助力开发人员和 IT 工作者提升效率。
...
## 📁 操作系统
  - 📂 **Macos**
    - 📄 [如何在MacOS下更改复制、粘贴等快捷键 以适应Windows下使用习惯（视频）](https://www.xmyy.com/article/How-to-Change-Copy-Paste-and-Other-Shortcuts-in-macOS)：《如何在MacOS下更改复制、粘贴等快捷键 以适应Windows下使用习惯》发表于《今日头条》,How to Change Copy, Paste, and Other Shortcuts in macOS
  ...
  - 📂 **Windows**
    ...
    - 📂 **Windows桌面**
      - 📄 [Win10忘记密码怎么办？3步教您重置Windows10密码](https://www.xmyy.com/article/3-Steps-to-Reset-Windows-10-Password)：《Win10忘记密码怎么办？3步教您重置Windows10密码》发表于《今日头条》,3 Steps to Reset Windows 10 Password
...
## 📁 软件开发
  ...
  - 📂 **前端开发**
    - 📄 [vite+vue3+ts手把手教你创建一个vue3项目](https://www.xmyy.com/article/Vite-vue3-TS-will-guide-you-step-by-step-to-create-a-Vue3-project)：一.pnpm管理项目为什么选择它？快: pnpm是同类工具速度的将近⒉倍高效: node_modules中的所有文件均链接自单一存储位置支持单体...
...
## 📁 数据库
  ...
  - 📂 **PostgreSQL**
    - 📄 [PostgreSQL备份与恢复实战：从零掌握pg_dump与pg_restore](https://www.xmyy.com/article/PostgreSQL-Backup-and-Recovery-in-Practice-Mastering-pgdump-and-pgrestore-from-scratch)：在数据库管理工作中，备份与恢复是最基础也是最重要的技能。无论是因为硬件故障、人为误操作还是系统升级，可靠的数据备份都是最...

  - 📂 **MongoDB**
    - 📄 [MongoDB备份与还原mongodump、mongorestore](https://www.xmyy.com/article/MongoDB-backup-and-restore-mongodump-mongorestore)：一、 MongoDB 备份MongoDB 备份的几种方式：mongodump系统快照(这里不做详细介绍，具体内容见官网：Back Up with Filesystem Sna...

  - 📂 **MySQL**
    - 📄 [mysql导入时出现“ERROR at line : Unknown command”的解决办法](https://www.xmyy.com/article/Solution-for-ERROR-at-line-Unknown-command-when-importing-MySQL)：mysql导入sql文件时报错了：C:\Users\Administrator>mysql -hlocalhost -uroot -pok118.com db_xmyy < D:\web\sonic\source\db_x...
...
## 📁 云原生
  - 📂 **可观测性**
    - 📄 [Kubernetes (K8s) 可观测性Observability](https://www.xmyy.com/article/Kubernetes-Observability)：可观测性了解如何通过收集指标、日志和追踪，实现对 Kubernetes 集群的端到端可视化。在 Kubernetes 中，可观测性是指收集和分析...

  - 📂 **GitOps**
    - 📄 [ArgoCD保姆级入门教程](https://www.xmyy.com/article/ArgoCD-beginner-tutorial-at-the-nanny-level)：Argo CD 是以 Kubernetes 作为基础设施，遵循声明式 GitOps 理念的持续交付（continuous delivery, CD）工具，支持多种配置管理...
...
## 📁 云计算
  - 📂 **DevOps**
    - 📂 **ELK**
      - 📄 [Elasticsearch - 修改最大值限制来解决max_result_window is too large问题](https://www.xmyy.com/article/Elasticsearch-how-to-modify-maximum-value-limits)：一、前言es响应数据量有限制，官方默认值为10000：如果实际查询到的数据超过这个值，就会报错：max_result_window is too large...

    - 📂 **Loki**
      - 📄 [Loki基础知识](https://www.xmyy.com/article/Loki-basics)：Grafana Loki是一组组件，可以组成一个功能齐全的日志聚合系统。Loki与其他日志系统不同是，它只会索引日志的元数据即labels(类...

    - 📂 **Grafana**
      - 📄 [Grafana中文入门教程](https://www.xmyy.com/article/Grafana-Chinese-Beginner-Tutorial)：这篇文章里我们从头到尾介绍了如何用 Grafana 生成仪表盘，如何配置和连接数据源，以及如何导入和创建一个仪表盘。

    - 📂 **Prometheus**
      - 📄 [Prometheus快速入门](https://www.xmyy.com/article/Prometheus-Quick-Start)：这篇文章从 Prometheus 的原理入门，剖析了 Prometheus 实现的原理，并且用一个简单的例子从零实现了一套业务监控系统。通过 Pro...

    - 📂 **Zabbix**
      - 📄 [zabbix实现原理及架构详解](https://www.xmyy.com/article/Detailed-explanation-of-Zabbix-implementation-principles-and-architecture)：zabbix是完全开源的工具，整合了cacti和nagios等特性。zabbix功能很强大，如何理解zabbix的功能，我们可以和cacti、nagios的功能...

    - 📂 **Terraform**
      - 📄 [史上最全Terraform入门教程，助你无坑入门](https://www.xmyy.com/article/The-most-comprehensive-Terraform-beginner-tutorial-ever-helping-you-get-started-without-pitfalls)：本文通过实际操作，使用Terraform在AWS上创建各种基础设施资源，包括VPC、子网、路由表、网关、安全组、EC2实例、EBS卷和弹性IP...

    - 📂 **Puppet**
      - 📄 [puppet详解](https://www.xmyy.com/article/Detailed-explanation-of-puppet)：一、puppet 介绍1、puppet是什么puppet是一个IT基础设施自动化管理工具，它能够帮助系统管理员管理基础设施的整个生命周期： 供...

    - 📂 **SaltStack**
      - 📄 [SaltStack快速入门](https://www.xmyy.com/article/saltstack-kuai-su-ru-men)：saltstack介绍Salt，一种全新的基础设施管理方式，部署轻松，在几分钟内可运行起来，扩展性好，很容易管理上万台服务器，速度够...
    ...
    - 📂 **Git**
      ...
      - 📄 [一文弄懂Gitflow、Github flow、Gitlab flow的工作流](https://www.xmyy.com/article/Understand-Gitflow-GitHub-Flow-and-GitLab-Flow-workflows-in-one-article)：Git 作为一个源码管理系统，不可避免涉及到多人协作。协作必须有一个规范的工作流程，让大家有效地合作，使得项目井井有条地发展...
  ...
  - 📂 **私有云**
    - 📂 **ProxmoxVE**
      - 📄 [Proxmox VE 9.1（PVE）安装保姆级教程（适用于最新版）](https://www.xmyy.com/article/Proxmox-VE-PVE-Installation-Assistant-Tutorial-Latest-Version)：本教程基于 Proxmox VE 9.1（截至 2026 年 2 月的最新稳定版）编写。安装流程与 7.x/8.x 系列高度相似，界面和选项基本一致，仅...

    - 📂 **VMwareCloud**
      - 📄 [如何通过ssh远程登录给esxi主机防火墙添加允许ip列表（视频）](https://www.xmyy.com/article/How-to-add-allow-ip-list-to-esxi-host-firewall-via-ssh-remote-login)：《如何通过ssh远程登录给esxi主机防火墙添加允许ip列表》发表于《今日头条》,How to add allow ip list to esxi host firewall via ssh remote login

    - 📂 **OpenStack**
      - 📄 [全网最全最详细两万字OpenStack知识图谱](https://www.xmyy.com/article/The-most-comprehensive-and-detailed-20000-word-OpenStack-knowledge-graph-on-the-entire-internet)：OpenStack简介OpenStack背景介绍.st0{fill:#EA2347;}.st1{fill:#504741;}OpenStack是一个自由、开源的云计算平台。它主要作为基...
...
## 📁 人工智能
  - 📂 **AI工具**
    - 📄 [AI工具软件有哪些？2026年主流AI工具分类全解析](https://www.xmyy.com/article/What-AI-tool-software-are-available-A-complete-analysis-of-mainstream-AI-tool-categories-for-2026)：随着人工智能技术的飞速发展，AI工具软件已深度融入工作、创作、生活等场景，成为提升效率、激发创意的核心助力。2026年，AI工具...

  - 📂 **AI开发**
    - 📂 **Agent**
      - 📄 [AI Agent框架深度解析：LangChain、AutoGen等五大框架如何选？开发者必看指南](https://www.xmyy.com/article/In-depth-Analysis-of-AI-Agent-Frameworks-How-to-Choose-Among-the-Five-Major-Frameworks)：本文对LangChain、AutoGen、Auto-GPT、MetaGPT和CrewAI五大主流AI Agent框架进行了技术深度分析，涵盖各框架的核心组件、实现原...

    - 📂 **RAG**
      - 📄 [RAG 是什么？16 种 RAG 方案万字一次讲清！](https://www.xmyy.com/article/What-is-RAG-16-RAG-solutions-explained-in-ten-thousand-words)：最近这两年，只要你接触过 AI 编程，大概率听过一个词，RAG（Retrieval-Augmented Generation）。但很多小伙伴对 RAG 都只是一知...

    - 📂 **MCP**
      - 📄 [一文搞懂 MCP：从入门到实战（含本地项目 MCP Server 示例）](https://www.xmyy.com/article/Understand-MCP-in-One-Article-From-Beginner-to-Practical-Including-Local-Project-MCP-Server-Examples)：用 MCP 打通本地项目与大模型：从概念到实战一文搞清：MCP 是什么、如何和 LangGraph / CrewAI / AutoGen 配合、以及如何给本地...

    - 📂 **LangChain**
      - 📄 [LangChain完整教程：六大组件+分层设计+完整项目实战](https://www.xmyy.com/article/Complete-LangChain-tutorial-Six-major-components-layered-design-complete-project-practice)：前言今天我想和大家分享一下我的LangChain学习历程,大多数文章要么止步于基础，要么直接跳入高级应用，却忽视了从理解到实践的关...

    - 📂 **TensorFlow**
      - 📄 [TensorFlow安装步骤、使用示例及常见问题应对](https://www.xmyy.com/article/TensorFlow-installation-steps-usage-examples-and-common-problem-responses)：一、TensorFlow安装（一）安装前准备环境要求Python版本：TensorFlow支持Python 3.7 - 3.11。确保你的Python环境已经正确安装并...

    - 📂 **PyTorch**
      - 📄 [PyTorch安装超详细教程（含多系统、多场景、避坑指南）](https://www.xmyy.com/article/Detailed-PyTorch-Installation-Tutorial-Including-Multiple-Systems-Multiple-Scenarios-Pitfall-Avoidance-Guide)：一、安装前准备1. 系统与硬件检查系统支持版本GPU 支持要求Windows10/11（64位）NVIDIA 显卡（CUDA 11.0+）macOS12+（Apple Sili...


  - 📂 **AI基础**
    - 📂 **异构计算**
      - 📄 [FPGA入门指南：从点亮第一颗LED开始](https://www.xmyy.com/article/FPGA-Beginner-Guide-Starting-with-Lighting-Up-Your-First-LED)：一、到底啥是FPGA？（电子工程师的乐高）刚接触硬件的同学可能会懵：这货和单片机有啥区别？简单来说，FPGA就像一张白纸（Field ...
    ...
    - 📂 **神经网络**
      - 📄 [神经网络浅讲：从神经元到深度学习](https://www.xmyy.com/article/A-Brief-Introduction-to-Neural-Networks-From-Neurons-to-Deep-Learning)：神经网络是一门重要的机器学习技术。它是目前最为火热的研究方向–深度学习的基础。学习神经网络不仅可以让你掌握一门强大的机器...
